    ...
    if request.method=="GET":
        return render(request,"manager_dash/add-room.html",{})
            ...
            if(not len(error)):
                ...
                room=Rooms(room_no=room_no,room_type=room_type,location=location,price=price,no_of_days_advance=no_of_days_advance,start_date=datetime.datetime.strptime(start_day, "%d %B, %Y").date(),room_image=room_image,manager=manager)
                room.save()
